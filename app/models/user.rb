class User < ApplicationRecord
	...
	validates :password_digest, presence: {message: "Please choose a password"},  length: {in: 6..16, message: "Password length too short or long. 6-16 characters"}
	...
	# add before actions to downcase email and password
	# downcase email
	# change to password
end
